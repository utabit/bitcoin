...
#ifndef UTABIT_TEST_SCRIPTNUM10_H
#define UTABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Utabit Core 0.10.0, for cross-comparison.
 */
public:
