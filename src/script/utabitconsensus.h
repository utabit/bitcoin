...
typedef enum utabitconsensus_error_t
{
    ...
    utabitconsensus_ERR_INVALID_FLAGS,
...
enum
{
    ...
    utabitconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = utabitconsensus_SCRIPT_FLAGS_VERIFY_P2SH | utabitconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               utabitconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | utabitconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                               utabitconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | utabitconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
