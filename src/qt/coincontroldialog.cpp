...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    int nDisplayUnit = UtabitUnits::UTB;
    ...
    QString toolTip3 = tr("This label turns red if any recipient receives an amount smaller than %1.").arg(UtabitUnits::formatHtmlWithUnit(nDisplayUnit, ::minRelayTxFee.GetFee(546)));
