...
QT_TRANSLATE_NOOP("utabit-core", "Utabit Core"),
QT_TRANSLATE_NOOP("utabit-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("utabit-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("utabit-core", "%s is set very high!"),
...
QT_TRANSLATE_NOOP("utabit-core", "Attempt to recover private keys from a corrupt wallet on startup"),
...
QT_TRANSLATE_NOOP("utabit-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("utabit-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("utabit-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("utabit-core", "Change index out of range"),
...
QT_TRANSLATE_NOOP("utabit-core", "Copyright (C) %i-%i"),
...
QT_TRANSLATE_NOOP("utabit-core", "Error loading %s"),
QT_TRANSLATE_NOOP("utabit-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("utabit-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("utabit-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("utabit-core", "Initialization sanity check failed. %s is shutting down."),
...
QT_TRANSLATE_NOOP("utabit-core", "Invalid amount for -%s=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("utabit-core", "Keypool ran out, please call keypoolrefill first"),
...
QT_TRANSLATE_NOOP("utabit-core", "Loading banlist..."),
...
QT_TRANSLATE_NOOP("utabit-core", "Print this help message and exit"),
...
QT_TRANSLATE_NOOP("utabit-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("utabit-core", "Rebuild chain state from the currently indexed blocks"),
...
QT_TRANSLATE_NOOP("utabit-core", "Rewinding blocks..."),
...
QT_TRANSLATE_NOOP("utabit-core", "Send transactions with full-RBF opt-in enabled (default: %u)"),
...
QT_TRANSLATE_NOOP("utabit-core", "Set maximum BIP141 block weight (default: %d)"),
...
QT_TRANSLATE_NOOP("utabit-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("utabit-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("utabit-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("utabit-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("utabit-core", "This is experimental software."),
QT_TRANSLATE_NOOP("utabit-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("utabit-core", "This is the transaction fee you will pay if you send a transaction."),
...
QT_TRANSLATE_NOOP("utabit-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("utabit-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("utabit-core", "Transaction must have at least one recipient"),
...
QT_TRANSLATE_NOOP("utabit-core", "Unable to bind to %s on this computer. %s is probably already running."),
...
QT_TRANSLATE_NOOP("utabit-core", "Use the test chain"),
...
QT_TRANSLATE_NOOP("utabit-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("utabit-core", "Wallet needed to be rewritten: restart %s to complete"),
