...
#ifndef UTABIT_QT_UTABITUNITS_H
#define UTABIT_QT_UTABITUNITS_H
...
/** Utabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UtabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UtabitUnits(QObject *parent);

    /** Utabit units.
      @note Source: https://en.utabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UBIT,
...
typedef UtabitUnits::Unit UtabitUnit;

#endif // UTABIT_QT_UTABITUNITS_H
