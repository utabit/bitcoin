...
// Copyright (c) 2009-2012 The Utabit Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Utabit/$1-%s The Utabit/' %s"
REGEX_CURRENT= re.compile("%s The Utabit" % year)
