...
* Update translations (ping wumpus, Diapolo or tcatm on IRC) see [translation_process.md](https://github.com/utabit/utabit/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/utabit/gitian.sigs.git
	git clone https://github.com/utabit/utabit-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/utabit/utabit.git

###Utabit maintainers/release engineers, update (commit) version in sources
...
###Build and sign Utabit Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit utabit=v${VERSION} ../utabit/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit utabit=v${VERSION} ../utabit/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit utabit=v${VERSION} ../utabit/contrib/gitian-descriptors/gitian-osx.yml
...
###Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../utabit/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [utabit-detached-sigs](https://github.com/utabit/utabit-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Release sticky on utabittalk: https://utabittalk.org/index.php?board=1.0

  - Utabit-development mailing list

  - Update title of #utabit on Freenode IRC

  - Optionally reddit /r/Utabit, ... but this will usually sort out itself
