...
This document provides guidelines for internationalization of the Utabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `utabit_en.ts` remains unchanged.
