Utabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/utabit/files/Utabit/utabit-0.5.4/
...
http://gitorious.org/utabit/utabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Utabit-Qt notifications under Growl 1.3.
Increase required age of Utabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUtabit properly when installing Utabit-Qt over it. (Windows)
