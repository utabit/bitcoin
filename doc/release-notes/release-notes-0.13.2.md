Utabit Core version 0.13.2 is now available from:

  <https://utabit.org/bin/utabit-core-0.13.2/>
...
- #8908 `4a974b2` Update utabit-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow utabit-tx to create v2 transactions (ubitdrak)
