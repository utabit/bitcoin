Download URL: https://sourceforge.net/projects/utabit/files/Utabit/utabit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UBIT fee schedule (users still pay 0.01 UBIT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #utabit00 - #utabit99
