Utabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/utabit/files/Utabit/utabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Utabit
...
New/changed settings (command-line or utabit.conf file)
--------------------------------------------------------
