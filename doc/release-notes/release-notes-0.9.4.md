Utabit Core version 0.9.4 is now available from:

  https://utabit.org/bin/0.9.4/
...
this update is incompatible with the Utabit system and could lead to consensus
forks.

Utabit Core released binaries from https://utabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~utabit/+archive/ubuntu/utabit
- A third-party or self-compiled Utabit Core

upgrade to Utabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
