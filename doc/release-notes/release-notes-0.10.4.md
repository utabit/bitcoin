Utabit Core version 0.10.4 is now available from:

  <https://utabit.org/bin/utabit-core-0.10.4/>
...
- #6953 `43c2789` Split utabit-tx into its own package
- #6953 `dfe0d4d` Include utabit-tx binary on Debian/Ubuntu
