...
import RPC call and node 0 sends UBIT to it. Then other nodes import the
...
In the second part of the test, node 0 sends more UBIT to each address, and the
...
class ImportRescanTest(UtabitTestFramework):
    def __init__(self):
        super().__init__()
