...
unlocked to sign the Utabit-Qt.app bundle.
...
allowing somebody to distribute a Utabit-Qt.app or utabit-qt-setup.exe with a valid
...
that the utabit-qt.exe file inside the installer had not been tampered with.
